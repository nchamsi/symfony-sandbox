...
class DataDogAuditLogAdmin extends Admin
{
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        ...
        $datagridMapper
            ->add('created_at_start', 'doctrine_orm_callback', array(
                'field_type' => \Sonata\CoreBundle\Form\Type\DatePickerType::class,
                'field_options' => array(
                    'format' => 'dd/MM/yyyy',
            ...
            ->add('blame', 'doctrine_orm_callback', array(
                'label' => 'User',
                'field_type' => \Symfony\Bridge\Doctrine\Form\Type\EntityType::class,
                'field_options' => array(
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        $listMapper
            ...
            ->add('action', null, array(
                    'template' => '@DataDogAudit/Admin/list__action_row.html.twig',
                    'label' => ' ',
                    'sortable' => false,
                    'attr' => array(
                        'width' => '20px'
            ...
            ->add('source.TypLabel', null, array(
                'template' => '@DataDogAudit/Admin/list__logs_row.html.twig'
            ))
            //->add('diff')
    ...
    public function getTemplate($name)
    {
        switch ($name) {
            case 'blame':
                return "@DataDogAudit/Admin/blame.html.twig";
        }
