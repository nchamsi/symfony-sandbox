...
class UserAdmin extends BaseAdmin
{
    ...
    protected $baseRoutePattern = 'security/users/users';
    ...
    protected function getUserMediaContextId()
    {
        ...
        $context = $this->getConfigurationPool()->getContainer()->get('doctrine')
            ->getRepository('App:Sonata\Classification\Context')
            ->find('users');

        if (is_null($context)) {
            $context = new \App\Entity\Sonata\Classification\Context();
            $context->setId('users');
            ...
            $defaultCategory = new \App\Entity\Sonata\Classification\Category();
    ...
    protected function configureFormFields(FormMapper $formMapper): void
    {
        ...
        $formMapper
            ...
            ->add('dateOfBirth', \Sonata\CoreBundle\Form\Type\DatePickerType::class, array(
                //'read_only' => true,
            ...
            ->add('gender', \Sonata\UserBundle\Form\Type\UserGenderListType::class, array(
                'required' => true,
                'translation_domain' => $this->getTranslationDomain(),
            ))
            ->add('locale', \Symfony\Component\Form\Extension\Core\Type\LocaleType::class, array('required' => false))
            //->add('timezone', 'timezone', array('required' => false))
            ->end()
            ->with('Image', array('class' => 'col-md-7'))
            ->add('media', \Sonata\MediaBundle\Form\Type\MediaType::class,
        ...
        if ($this->getSecurityAuthorizationChecker()->isGranted('ROLE_ADMIN')) {
            $formMapper
                ...
                ->end()
                ->with('Groups')
                ->add('groups', \Sonata\AdminBundle\Form\Type\ModelType::class, array(
                    'label' => false,
                    'required' => false,
                    'expanded' => true,
                    'multiple' => true,
    ...
    public function getTemplate($name)
    {
        switch ($name) {
            case 'show':
                return "@SonataUser/Admin/show.html.twig";
            case 'edit':
                if (!$this->isGranted('ROLE_SUPER_ADMIN')) {
                    return "@SonataUser/Admin/edit.html.twig";
                }
                break;
        }
