...
class AuditExtension extends \Twig_Extension
{
    ...
    {
        return $twig->render("AppBundle:Admin:Audit/{$log->getAction()}.html.twig", compact('log', 'admin'));
    }
    ...
    public function icon(\Twig_Environment $twig, AuditLog $log)
    {
        ...
        return $twig->render("AppBundle:Admin:Audit/icon.html.twig", compact('log', 'icon', 'icon_color'));
    }

    public function assoc(\Twig_Environment $twig, $assoc)
    {
        return $twig->render("AppBundle:Admin:Audit/assoc.html.twig", compact('assoc'));
    }
    
    public function diff(\Twig_Environment $twig, AuditLog $log, $admin)
    {
        return $twig->render("AppBundle:Admin:Audit/diff.html.twig", compact('log', 'admin'));
    }

    public function blame(\Twig_Environment $twig, $blame)
    {
        return $twig->render("AppBundle:Admin:Audit/blame.html.twig", compact('blame'));
    }
