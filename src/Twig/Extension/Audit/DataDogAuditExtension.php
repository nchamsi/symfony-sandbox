...
namespace App\Twig\Extension\Audit;

use DataDog\AuditBundle\Entity\AuditLog;

class DataDogAuditExtension extends \Twig_Extension
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $twig->render("@DataDogAudit/Admin/{$log->getAction()}.html.twig", compact('log', 'admin'));
    }
    ...
    public function icon(\Twig_Environment $twig, AuditLog $log)
    {
        ...
        return $twig->render("@DataDogAudit/Admin/icon.html.twig", compact('log', 'icon', 'icon_color'));
    }

    public function assoc(\Twig_Environment $twig, $assoc)
    {
        return $twig->render("@DataDogAudit/Admin/assoc.html.twig", compact('assoc'));
    }
    
    public function diff(\Twig_Environment $twig, AuditLog $log, $admin)
    {
        return $twig->render("@DataDogAudit/Admin/diff.html.twig", compact('log', 'admin'));
    }

    public function blame(\Twig_Environment $twig, $blame)
    {
        return $twig->render("@DataDogAudit/Admin/blame.html.twig", compact('blame'));
    }
    ...
    {
        return 'datadog_audit_extension';
    }
}
